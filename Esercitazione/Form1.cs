namespace Esercitazione
{
    public partial class Form1 : Form
    {
        ...
        DispElettronico Smartphone = new DispElettronico("AA004", "Smartphone", "Samsung", "Telefono Intelligente", 599, "467642767");
        public float prezzo;
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            lista.Items.Add(Smartphone.Prezzo + "$ " + Smartphone.Nome);
